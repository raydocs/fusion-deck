...
card({
  ...
  title:'Sixty-six defects, and who caught them',
  sub:'one tick = one defect · dot marks every fifth · ten review passes on this branch',
  src:'TICK ROWS · MONO-BASIC · DEFECT LEDGER',
  h:248,
  draw(s){
    const D=[['PANEL FOUND',45],['SELF-INFLICTED',11],['SELF-AUDIT',10]];
    ...
    txt(s,{x:200,y:196,'font-size':7,'font-weight':600,fill:'#B0AFA9','text-anchor':'middle',
      ...
      'PANEL FOUND = CAUGHT BY A SECOND READER THE AUTHOR DID NOT HAVE · 66 FOUND, 5 OPEN AND NAMED');
  }
});
